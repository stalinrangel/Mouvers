...
class MsgRepAdmin extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'msgs_rep_admin';
    ...
    // Relación de msgs_rep_admin con usuarios (emisor):
	...
	// Relación de msgs_rep_admin con usuarios (receptor):
