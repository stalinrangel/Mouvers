...
export class RutaBaseService {
	...
	public images_base = 'http://localhost/gitHub/Mouvers/mouversAPI/public/images_uploads/';
	...
	//Remoto vps
	//public api_base = 'https://api.mouvers.mx/';
	//public images_base = 'https://api.mouvers.mx/images_uploads/';
